        ...
        with Progress(
            ...
            try:
                ...
                progress.update(
                    ...
                    description=f"[green]✓[/green] Created {len(self.created_repositories)} repositories",
                )
                ...
                if component_repos:
                    ...
                    progress.update(
                        main_task,
                        completed=completed_steps,
                        description=f"[green]✓[/green] Created {len(self.created_components)} components",
                    )
                ...
                if resolved_scenario.environments:
                    ...
                    progress.update(
                        main_task,
                        completed=completed_steps,
                        description=f"[green]✓[/green] Created {len(self.created_environments)} environments",
                    )
                ...
                progress.update(
                    main_task,
                    completed=completed_steps,
                    description=f"[green]✓[/green] Created {len(self.created_applications)} applications",
                )
